...
export const INVITATION_UPDATE_FINISH = "INVITATION_UPDATE_FINISH";
...
export const INVITATION_FETCH_SUCCESS = "INVITATION_FETCH_SUCCESS";
export const INVITATION_FETCH_FAIL = "INVITATION_FETCH_FAIL";
